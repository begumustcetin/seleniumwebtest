...
public class TestOptimization extends MainTest {
    @Test
    public void gittiGidiyorTest() throws InterruptedException {
        ...
        Log4j.info("The text writte button is: " + accountButtonText);
        assertTrue(accountButtonText.contains("Hesabım"));

        Log4j.info("The word 'monitör' is entered in the search box.");
        SearchResultPage searchResultPage = homePage.search("monitör");
